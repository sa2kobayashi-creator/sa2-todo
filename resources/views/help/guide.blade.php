        ...
        @else
          <section class="help-section">
            ...
            <ul>
              ...
              <li>路線検索の電車・バスは <strong>NAVITIME</strong> または <strong>駅すぱあと</strong> を登録します。Google Maps Routes は日本の交通機関ルートが API の提供対象外です。未登録のときは福岡都心の内蔵ダイヤで検索します。地図の車・徒歩ルートに Google Maps Routes を使います。</li>
