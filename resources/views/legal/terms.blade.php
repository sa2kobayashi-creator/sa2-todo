      ...
      <div class="auth-card panel" style="max-width:720px;text-align:left;">
        ...
        @if(($htmlLang ?? app()->getLocale()) === 'en')
          <section class="legal-section" style="line-height:1.7;">
            ...
            <h2 style="font-size:1.05rem;margin-top:1.25rem;">5. Paid plans and formation of contract</h2>
            <p>The service offers a free plan (Light) and paid plans (Standard, tenant contract, dedicated instance) plus options (mailbox, storage overage). A paid contract is formed when you complete the order and the payment processor approves the transaction. Where a free trial applies, the contract is formed at the time of order and the first charge occurs on the last day of the trial.</p>
        ...
        @else
          <section class="legal-section" style="line-height:1.7;">
            ...
            <h2 style="font-size:1.05rem;margin-top:1.25rem;">5. 有料プランと契約の成立</h2>
            <p>本サービスには無料プラン（ライト）と有料プラン（スタンダード、テナント契約、専用インスタンス）およびオプション（メールボックス、ストレージ超過）があります。有料プランの契約は、利用者が申込内容を確認して申込操作を行い、決済事業者による決済の承認が完了した時点で成立します。無料お試し期間がある場合は、申込操作の時点で契約が成立し、お試し期間の終了日に最初の請求が発生します。</p>
