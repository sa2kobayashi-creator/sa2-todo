...
| 無料枠 | **ユーザーごと。Light 20GB（お試し） / Standard 200GB**（R2+B2 合算相当） |
...
- **1A:** 無料枠はユーザーごと。Light **20GB（お試し）** / Standard（有料）**200GB**（2026-08-28 に 50GB→20GB へ見直し）
- **2A（今）:** 超過は見込料金表示のみ
...
| プラン | 枠 | 保存 | 役割 |
|---|---|---|---|
| **Light** | **20GB（お試し）** | 原本 B2。サムネは Cloudinary／軽量 | 短期間の試用。本利用は Standard へ |
...
- Light: 「まず 20GB のお試し。本格的に残すなら Standard」
...
個人販売の枠とメッセージは **「個人販売（販路 B）で Photos を売りにする」** を正とする（Light **20GB お試し** / Standard **200GB**）。下表の Plus 3段階は円熟後の速度課金メモで、個人の初回販売では使わない。
