...
return [
    ...
    /** ユーザーあたりの無料枠（合計バイト）。R2+B2 合算の製品無料枠。既定 20GB（Light） */
    'user_free_quota_bytes' => (int) env('PHOTO_USER_FREE_QUOTA_BYTES', 20 * 1024 * 1024 * 1024),

    /** Standard（有料契約）の無料枠。Light 以上にする。既定 100GB */
    'standard_quota_bytes' => (int) env('PHOTO_STANDARD_QUOTA_BYTES', 100 * 1024 * 1024 * 1024),
